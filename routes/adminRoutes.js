...
router.route('/block/:id').get(isAdminLoggedIn,getUserBlock)
router.route('/unBlock/:id').get(isAdminLoggedIn,getUserUnblock)
...
router.route('/addCategory').post(postAddCategory)
